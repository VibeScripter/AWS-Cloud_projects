...
- In Project-1, we have setup our 3-Tier Application manually. but this time we will create bash scripts to automate our VM creation/provisioning through Vagrantfile.
...
cd /tmp/
git clone -b local-setup https://github.com/VibeScripter/vprofile-project-2.git
...
```sh
git clone https://github.com/VibeScripter/vprofile
```
